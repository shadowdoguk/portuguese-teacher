...
// Valid MPEG-2 Layer III silent MP3 (ID3v2 header + 7 × 48-byte frames at
// 16 kbps, 24 kHz, mono). 360 bytes total. LAME-encoded on
// 2026-07-22 via `@breezystack/lamejs@1.2.7`. Required so browsers can
// actually decode the audio element (`<audio src=…>` `readyState >= 1`).
// The previous placeholder was just an MP3 frame header followed by 28
// zero bytes — `file(1)` would call it "MPEG ADTS" but no browser can
// decode a 32-byte MP3, so the `<audio>` element stayed at `readyState=0`
// and the autoplay/replay UI silently failed. Keep this in sync with the
// prebuilt `public/assets/tts/*.mp3` files (regenerate via
// `pnpm assets:tts`).
const SILENT_MP3_BYTES = Uint8Array.from([
  ,
